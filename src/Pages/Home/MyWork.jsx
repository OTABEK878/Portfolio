...
export default function MyPortfolio() {
  const handleCardClick = (id) => {
    if (id === "1") {
      window.open("https://github.com/OTABEK878/myticket", "_blank");
    } else if (id === "2") {
      window.open("https://github.com/OTABEK878/my-first-project-backend", "_blank");
    }
  };

  const handleGitHubClick = () => {
    window.open("https://github.com/OTABEK878", "_blank");
  };
